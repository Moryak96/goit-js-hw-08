...
// description — текстовий опис зображення, для атрибута alt малого зображення та підпису великого зображення в модальному вікні.
...
gallery.addEventListener('click', handleClickModal);
...
function handleClickModal(event) {
  ...
  const instance = basicLightbox.create(
    `
  	<div class="modal">
      <img src="${imgSrc}" alt="${event.target.description}" >
    </div>
  `,
    { closable: true }
  );
